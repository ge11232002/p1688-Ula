...
## BEC
# setwd("/home/gtan/analysis/p1688-Ula/ImperialCollege/BEC_20190409_ICS/GOEnrichment")

## BAL
setwd("/home/gtan/analysis/p1688-Ula/ImperialCollege/BAL_20190409_ICS/GOEnrichment")

comparisonFns <- c("results_groupICSHDM_DAY14-groupICSHDMNeg_DAY14.tsv",
                   "results_groupICSHDM_DAY4-groupICSHDM_DAY14.tsv",
                   "results_groupICSHDM_DAY4-groupICSHDMNeg_DAY4.tsv",
                   "results_groupICSHDMNeg_DAY4-groupICSHDMNeg_DAY14.tsv",
                   "results_(groupICSHDM_DAY4-groupICSHDM_DAY14)-(groupICSHDMNeg_DAY4-groupICSHDMNeg_DAY14).tsv")
