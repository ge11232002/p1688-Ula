...
grouping <- list("Healthy"=c("DJ116","DJ114","DJ47","DJ101","DJ56","DJ48","DJ81"),
                 "AsthmaAll"=c("DJ144", "DJ129", "DJ121", "DJ139", "DJ92", "DJ148", "DJ67", "DJ113", "DJ75", "DJ61", "DJ136", "DJ86", "DJ60", "DJ125", "DJ73", "DJ134", "DJ126"))
...
for(sample in samples){
  message(sample)
  wdDir <- file.path(dataRoot, paste0(sample, "_", "2019-07-08"))
  dir.create(wdDir)
  setwd(wdDir)
  phenoData <-
  ...
  ### PCA with all probes
  expValue <- exprs(eset)
  allGroups <- list("Healthy"="Healthy", "AsthmaAll"="AsthmaAll", 
                    "All"=c("Healthy", "AsthmaAll"))
  onegroup <- names(allGroups)[1]
  ...
  contrasts <- makeContrasts(groupAsthmaAll_DAY4 - groupAsthmaAll_DAY14,
                             groupHealthy_DAY4 - groupHealthy_DAY14,
                             
                             groupAsthmaAll_DAY14 - groupHealthy_DAY14,
                             groupAsthmaAll_DAY4 - groupHealthy_DAY4,
                             
                             (groupAsthmaAll_DAY4 - groupAsthmaAll_DAY14)-(groupHealthy_DAY4 - groupHealthy_DAY14),
                             levels=design)
